...
inline const strd::Mat4 operator*(const strd::Mat4 &a, const strd::Mat4 &b)
{
    return strd::matrix::multiply(a, b);
}

inline const strd::Vec4f operator*(const strd::Mat4 &a, const strd::Vec4f &b)
{
    return strd::matrix::multiply(a, b);
}

inline const strd::Vec3f operator*(const strd::Mat4 &a, const strd::Vec3f &b)
{
    return strd::matrix::multiply(a, b);
}