#pragma once
    ...
    #define PLATFORM_WINDOW strd::Win32_Window;
    using PlatformWindow = strd::Win32_Window;
#endif
#if defined (__linux__)
    #include "x11_window.h"
    #define PLATFORM_WINDOW strd::X11_Window;
    using PlatformWindow = strd::X11_Window;
#endif
